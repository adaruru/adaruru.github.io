...
![image-20250217124735953](attach/image-20250217124735953-17465930807531.png)
...
![image-20250217124833424](attach/image-20250217124833424-17465930807532.png)
...
![image-20250217125911585](attach/image-20250217125911585-17465930807533.png)
...
![image-20250217124914340](attach/image-20250217124914340-17465930807534.png)

## Markdown 語法

<img src="attach/markdownsyntex.png" alt="image-20250217095933173" style="zoom:67%;" />
...
<img src="attach/markdowneffect.jpg" alt="img" style="zoom:50%;" />
...
![image-20250207095217939](attach/image-20250207095217939-173976474289760-1739764830938122-17465930807537.png)
...
![image-20250207101247773](attach/image-20250207101247773-173976474289761-1739764830938125-17465930807538.png)

## 級數標題 是連結 也是目錄

`[[_TOC_]]` 就會把所有級數標題集成目錄，可以點選

![image-20250217104357476](attach/image-20250217104357476-173976474289762-1739764830938124-17465930807539.png)
...
![image-20250217104610205](attach/image-20250217104610205-173976474289763-1739764830938126-174659308075411.png)



azure 的 wiki 其實就是一個 git  repostary, clone 下來用法與 git 都一樣 

![image-20250217104944444](attach/image-20250217104944444-173976474289764-1739764830938127-174659308075410.png)
...
![image-20250217104822610](attach/image-20250217104822610-173976474289765-1739764830938128-174659308075413.png)

---

azure 專案 readme 也可以像 wiki 一樣查看，大多開源專案的說明文件，就是放在根目錄的 readme, gitbub 上有很多

![image-20250217105207593](attach/image-20250217105207593-173976474289766-1739764830938130-174659308075412.png)
...
![image-20250307113321033](attach/image-20250307113321033-174659308075416.png)



## Checkbox 使用

![image-20250307114445166](attach/image-20250307114445166-174659308075414.png)

---

也可以選取一段文字，讓其全部都變成 check box

![image-20250307114554264](attach/image-20250307114554264-174659308075415.png)

---

直接點可以互動打勾，打勾的樣子

![image-20250307114614199](attach/image-20250307114614199-174659308075417.png)
...
![image-20250307114326637](attach/image-20250307114326637-174659308075418.png)

---

離開編輯畫面，就會是簡短的樣子

![image-20250307114406234](attach/image-20250307114406234-174659308075419.png)

## table 使用

Ctrl + t : 新增 table

![image-20250217112706201](attach/image-20250217112706201-173976474289767-1739764830938129-174659308075420.png)

---

所有網頁的 tr、th、td 都可以簡單ctrl c, ctrl v 的 md 文件

![image-20250217113003581](attach/image-20250217113003581-173976474289768-1739764830939133-174659308075421.png)

---

所有列、攔都可以拖曳變更位置

![image-20250217113254704](attach/image-20250217113254704-173976474289769-1739764830939132-174659308075422.png)
...
![image-20250217113340709](attach/image-20250217113340709-173976474289770-1739764830939131-174659308075423.png)
...
- 檔名避免使用特殊符號 `#`, `?`, `&`, etc.) 會倒置路徑變成  .attach/.C%23 使圖片顯示路徑錯誤，比如 `.C#` will be encoded as `.C%23`, which may cause the photo to fail to load.
...
Typora 相對位置處理圖片，路徑使用 ./.attach/.${filename}

![image-20241114150224347](attach/image-20241114150224347-173889219812626-173976474289771-1739764830939134-174659308075424.png)

---

![image-20241114150917531](attach/image-20241114150917531-173889219812631-173976474289772-1739764830939135-174659308075425.png)



---

- 在這樣的配置之下，每一個檔案都會在複製上圖片的時候，新增一個資料夾，在相對路徑的地方新增與檔案同名的 (.attach/.TyporaSlide) 資料夾
- 路徑像這樣

```
![image-20241114150917531](.attach/.TyporaSlide/image-20241114150917531-173889219812631-173889542464476.png)
```
...
![image-20250207103339022](attach/image-20250207103339022-173976474289873-1739764830939136-174659308075426.png)

---

- 變成路徑，檔名就要小心

- 檔名避免使用特殊符號 `#`, `?`, `&`, etc.) 會倒置路徑變成  .attach/.C%23 使圖片顯示路徑錯誤
...
* 避免在檔案總管或其他工具中混亂
  一般情況下，像 `.git/`、`.attach/` 等以「`.`」開頭的資料夾會被視為系統或隱藏資料夾，從而減少開發者在檔案樹狀結構中誤操作或誤刪除。
* 和普通目錄區分
...
![image-20250307121718603](attach/image-20250307121718603-174659308075427.png)
...
```html
# 加入屬性 width
<img src=".attach/.XXX/image-20251015141308550.png" width="100">
# 圖片右鍵 Zoom image 選擇縮小比例
<img src="attach/aligndemo.png" alt="image-20250605103033878" style="zoom:33%;" />
```
...
![image-20250217121619775](attach/image-20250217121619775-174659308075428.png)
...
![image-20250217122516889](attach/image-20250217122516889-174659308075429.png)
...
![image-20250217122520818](attach/image-20250217122520818-174659308075430.png)
...
![image-20250217111619175](attach/image-20250217111619175-173976474289874-1739764830939137-174659308075431.png)
...
![image-20250217133947947](attach/image-20250217133947947-174659308075432.png)
...
![image-20250217135010349](attach/image-20250217135010349-174659308075433.png)
...
![image-20241114153155586](attach/image-20241114153155586-173889219812629-173976474289876-1739764830939139-174659308075434.png)
...
![image-20250217123246206](attach/image-20250217123246206-174659308075435.png)



word 檔案匯出，原本的級數標題都會變成 word 格式支援的標題類

![image-20250217130938370](attach/image-20250217130938370-174659308075436.png)
...
![image-20250217132832751](attach/image-20250217132832751-174659308075437.png)
...
![image-20250217131250440](attach/image-20250217131250440-174659308075438.png)
...
![image-20241114151348378](attach/image-20241114151348378-173889219812627-173976474289877-1739764830939140-174659308075439.png)
...
![image-20241114151738570](attach/image-20241114151738570-173889219812628-173976474289878-1739764830939141-174659308075440.png)
